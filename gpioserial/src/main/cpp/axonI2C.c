...
JNIEXPORT jint JNICALL Java_com_gpioserial_gpio_axonI2C_open(JNIEnv *env, jobject obj, jstring file)
{
    char fileName[64];
    const char *str;
...
JNIEXPORT jint JNICALL Java_com_gpioserial_gpio_axonI2C_read(JNIEnv * env, jobject obj, jint fileHander, jint slaveAddr, jintArray bufArr, jint len)
{
    jint *bufInt;
    char *bufByte;
    int res = 0, i = 0, j = 0;
...
JNIEXPORT jint JNICALL Java_com_gpioserial_gpio_axonI2C_write(JNIEnv *env, jobject obj, jint fileHander,
...
JNIEXPORT void JNICALL Java_com_gpioserial_gpio_axonI2C_close(JNIEnv *env, jobject obj, jint fileHander)
{
    close(fileHander);
}
...
JNIEXPORT jint JNICALL Java_com_gpioserial_gpio_axonI2C_setdirectionGPIO(JNIEnv *env, jobject obj, jstring gpio, jint direction)
{
    char fileName[64];
    char bufByte[10];
    const char *str;
...
JNIEXPORT jint JNICALL Java_com_gpioserial_gpio_axonI2C_setoutputGPIO(JNIEnv *env, jobject obj, jstring gpio, jint state)
{
    char fileName[64];
    char bufByte[10];
	const char *str;
...
JNIEXPORT jint JNICALL Java_com_gpioserial_gpio_axonI2C_readGPIO(JNIEnv *env, jobject obj, jstring gpio)
{
    char fileName[64];
    char bufByte[10];
    const char *str;
